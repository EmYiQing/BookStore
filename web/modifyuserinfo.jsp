            ...
            <td width="25%">
                <table width="100%" border="0" cellspacing="0"
                    ...
                    <tr>
                        <td class="listtd"><img src="images/miniicon.gif" width="9"
                                                height="6"/>&nbsp;&nbsp;&nbsp;&nbsp; <a
                                href="${pageContext.request.contextPath}/findOrder">订单查询</a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="listtd"><img src="images/miniicon.gif" width="9"
                                                height="6"/>&nbsp;&nbsp;&nbsp;&nbsp; <a
                                href="${pageContext.request.contextPath}/logout">用戶退出</a>
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <tr>
                        <td>
                            <form action="${pageContext.request.contextPath}/modifyUserInfo" method="post">
                                <input type="hidden" name="id" value="${modify_user.id}">
                                <table width="100%" border="0" cellspacing="2" class="upline">
                                    <tr>
                                        <td style="text-align:right; width:20%">会员邮箱：</td>
                                        <td style="width:40%; padding-left:20px">${modify_user.email}</td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-left:20px">${modify_user.username}</td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">&nbsp;&nbsp;<input type="radio"
                                                                           name="gender" value="男"
                                        <c:if test="${modify_user.gender=='男'}">
                                                                           checked="checked"/> 男
                                            </c:if>
                                            <c:if test="${modify_user.gender!='男'}">
                                                /> 男
                                            ...
                                            <c:if test="${modify_user.gender=='女'}">
                                                    checked="checked"/> 女
                                            </c:if>
                                            <c:if test="${modify_user.gender!='女'}">
                                                /> 女
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2"><input name="telephone" type="text"
                                                               value="${modify_user.telephone}" class="textinput"/>
                                        </td>
                                    </tr>
